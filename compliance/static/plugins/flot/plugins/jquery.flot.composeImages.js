...
function, which generates temporary files out of them. This function
...
failure in generating the temporary image. Temporary files are required
...
After all temporary files are generated, they are overlapped using
...
temporary files load their data.
*/
    ...
    function getGenerateTempImg(tempImg, canvasOrSvgSource) {
        ...
        return function doGenerateTempImg(successCallbackFunc, failureCallbackFunc) {
            ...
            tempImg.onabort = function(evt) {
                ...
                successCallbackFunc(tempImg); //call successCallback, to allow snapshot of all working files
            };
    ...
    function prepareImagesToBeComposed(sources, destination) {
        ...
        if (sources.length === 0) {
            ...
            if ((maxX - minX <= 0) || (maxY - minY <= 0)) {
                result = NEGATIVEIMAGESIZE; //this might occur on hidden files
            } else {
